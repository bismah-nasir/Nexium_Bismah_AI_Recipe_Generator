...
//     const cardBg = variant === "white" ? "bg-white" : "bg-[#fff1e6]"; // peachy color for non-white backgrounds

//     return (
//         <Link
//             href={`/recipes/${recipe._id}`}
//             className={`block ${cardBg} p-4 rounded-lg border border-orange-300 shadow hover:shadow-lg transition`}>
//             {/* Recipe Title */}
...
//     return (
//         <Link
//             href={`/recipes/${recipe._id}?from=${from}`} // ✅ add query param dynamically
//             className="block bg-white p-4 rounded-lg shadow hover:shadow-lg transition max-w-sm">
//             {/* Recipe Title */}
//             <h4 className="text-lg font-semibold text-orange-600 mb-1">
//                 {recipe.recipe.title}
//             </h4>
